var Interface = {
  ...
  initialize : function initialize( a_options )
  {
    ...
    this.options.debug      = a_options.debug      || this.options.debug;
  ...
  tick : function tick()
  {
    ...
    if( this.handbrake ){
      //clearInterval( this.ticker ); // using setInterval for queing ticks is not an optimal solution
    ...
    clearTimeout( this.ticker );
    this.ticker = setTimeout( 'Interface.tick();', this.options.speed );
  },
  ...
  startTicker : function startTicker()
  {
    ...
    // using setInterval for queing ticks is not an optimal solution
    //clearInterval( this.ticker );
    //this.ticker = setInterval( 'Interface.tick();', this.options.speed );
  },
  ...
  {
    this.options.speed = this.gameSpeeds[ $('#gameSpeed').val() ].time;
  },
